...
async function run() {
    ...
    credentials.fetch = async (edhoc) => {
        console.log("credentials.fetch", edhoc, edhoc.connectionID);
    }

    credentials.verify = async (edhoc) => {
        console.log("credentials.verify", edhoc, edhoc.connectionID);
    }
    ...
    try {
        ...
        console.log(chalk.red("Message 2 - C_R"), c_r);    
