...
async function run() {
    ...
    const initiator = new addon.LibEDHOC(12, 0, [1, 2], credentials, crypto);
    const responder = new addon.LibEDHOC(20, 0, [2, 3], credentials, crypto);
    
    console.log("Initiator", initiator.cipherSuites);
    console.log("Responder", responder.cipherSuites);
