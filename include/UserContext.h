 ...
 * 
 * The UserContext class encapsulates the necessary components for the Edhoc protocol,
 * including the crypto manager, EAD manager, and credential manager. It also provides
 * access to a logger and a parent object reference.
 */
class UserContext {
public:
    /**
