...
public:
     ...
     * @param args A vector of N-API values representing the arguments to pass to the function.
     * @param callbackLambda A lambda function to handle the result of the function call.
     */
