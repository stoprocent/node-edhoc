...
EdhocEadManager::~EdhocEadManager() { eadBuffers.clear(); }

void EdhocEadManager::StoreEad(enum edhoc_message message, int label,
...
const EadMapVector *
EdhocEadManager::GetEadByMessage(enum edhoc_message message) const {
...
int EdhocEadManager::ComposeEad(void *user_context, enum edhoc_message message,
  ...
  return manager->callComposeEad(message, ead_token, ead_token_size,
                                 ead_token_len);
}

int EdhocEadManager::ProcessEad(void *user_context, enum edhoc_message message,
